...
def extract_first_1gb(input_file, output_file, max_bytes):
    ...
    with open(input_file, 'r', encoding='utf-8') as fin, open(output_file, 'w', encoding='utf-8') as fout:
        ...
        # Write lines until we reach ~1 GB
        for line in fin:
